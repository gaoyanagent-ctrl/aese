...
- [M10 Agent 候选与参数化工厂建设交互计划](docs/plans/2026-08-01-m10-interactive-agent-plant-build.md)
...
- [M11 Project Genesis 生产能力建设设计](docs/designs/DES-012-genesis-production-capability-build.md)
...
- [M13 Project Genesis 第一次完整商业交付设计](docs/designs/DES-014-genesis-first-commercial-delivery.md)
- [M13 Project Genesis 第一次完整商业交付实施计划](docs/plans/2026-07-22-m13-genesis-first-commercial-delivery.md)
- [M13 First Delivery 运行手册](docs/runbooks/genesis-first-delivery.md)
