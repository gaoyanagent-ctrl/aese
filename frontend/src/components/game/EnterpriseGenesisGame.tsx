...
const missionTitles:Record<string,string>={
 ...
 "finance.organization.configure":"建立开业财务组织","accounting.book.activate":"启用会计账套与期间",
 "chart.of.accounts.activate":"启用开业科目表","capital.contribution.post":"过账实缴资本凭证",
