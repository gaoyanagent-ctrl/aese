...
export function ScenarioLab({onExit}:{onExit:()=>void}){
 ...
 <section className="world-status"><strong>结论限制</strong><p>{e.conclusion_limit}</p><button onClick={()=>{window.location.hash="world-strategy-control"}}>进入 Strategy Control Room</button></section></main></div>
}
