...
本文是给后续 agent 的项目背景入口。进入 `/iaos/aese` 后，请先阅读本文，再阅读 `docs/AESE_MVP_Blueprint.md`、`docs/HCTM_Virtual_Enterprise_Blueprint.md`、`docs/HCTM_Master_Data_Model.md`、`docs/HCTM_Event_Model.md`、`docs/HCTM_Seed_Data_Plan.md` 和 `docs/progress-log.md`。
