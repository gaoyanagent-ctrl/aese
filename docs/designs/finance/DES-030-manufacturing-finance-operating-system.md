...
- 集团、法人、BU、基地/工厂、财务组织、共享服务中心、Data Set 和组织授权；
- 共享科目表/科目定义、法人扩展、财政日历/期间、账簿/账簿集；
- Business Partner canonical identity、客户/供应商角色与组织扩展，以及产品/工厂扩展；
- IAOS Runtime 2.3.0 将上述 16 类权威模型发布为可在数据模型工坊发现的
  Semantic/Entity 资产，并在同一受治理 Capability 事务维护运行投影；
- 七个职责单一的财务业务入口：账务与报表、组织与待办、多组织与共享数据、
  账簿与会计基础、客户、供应商和产品。
...
“财务账务与报表”只承担已提交账务查询和报表输出，不承载组织、待办或主数据维护。
配置入口与数据入口的详细职责见 DES-031 §1.4、DES-036 §7 和 IAOS DES-070。
