...
| M9 IAOS 原生真实闭环设计 | `docs/designs/DES-027-m9-iaos-native-incorporation-closed-loop.md`；已批准的三层语义、平台主体、Runtime Artifact、Capability/Process、菜单、Trace Spine、World Bridge、十二项闭环门、D19 通用资产可发现性、D20 逐步骤追踪及 D21 Capability/流程级目的/节点级步骤的可解释客户配置合同 |
