...
| M10 交互修订 active plan | `docs/plans/2026-08-01-m10-interactive-agent-plant-build.md`、`world-contracts/schemas/plant-build-interactive.schema.json`、`internal/plantbuild/interactive.go`、`internal/creative/minimax_provider.go::CompleteJSON`、`internal/httpapi/server.go`、`internal/iaosclient/client.go`、`frontend/src/lib/clientRequestId.ts`；IAOS `incorporation/plant_entities.go`、`plant_entity_projections.go`、`api/plant_interactive.go`、`api/plant_site_control.go`、`api/plant_process_run.go` | 已落地严格合同、MiniMax adapter、CreativeJob、财务快照、Agent/人工 Proposal、Review、World wait/Observation、权威推荐/Approval/正式选址和场址控制交付；`facility.plant.planning.v1` 串起选址的人/Agent/World/审批，`facility.plant.delivery.v1` 以园区权利人协议/交接 Observation 形成场址控制。场址交付采用最小玩家确认命令，`GenerateSiteControlObservation` 从 IAOS 权威请求生成可重放的协议、交接与占有证据，浏览器不再填写外部事实。十一类业务对象均为同事务只读 Entity 投影；WBS/合同/施工/工程财务仍待实现 |
