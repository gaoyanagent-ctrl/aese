...
| M9N 平台基础语义消费 | IAOS `docs/designs/DES-071-semantic-governance-and-foundation-seed.md`、`platform/internal/semantic/foundation/foundation.v1.json`、Runtime 2.5.0、`docs/solutions/SOL-044-entity-semantic-inheritance-and-governed-record-browser.md`；AESE `docs/plans/2026-07-23-m9-iaos-native-incorporation-closed-loop.md` §20/§22 | AESE/M9 只引用平台 Concept/Archetype；场景 seed 不得覆盖 foundation-owned 资产；新增前先执行目录检索并取得语义变更批准；旧 Entity source 经平台包修复后重新编译 Effective Artifact |
