...
| M9 IAOS 原生真实闭环设计 | `docs/designs/DES-027-m9-iaos-native-incorporation-closed-loop.md`；已批准的三层语义、平台主体、Runtime Artifact、Capability/Process、菜单、Trace Spine、World Bridge、十二项闭环门及 D19 通用资产可发现性机器门 |
