...
| M10 Genesis Plant Build | Agent 辅助候选、人工选址、参数化投资、场地控制、设施项目、公用工程、异常重排与验收 | Reference Replay Complete; Interactive Revision Pending | 已实现 M9 同世界交接、全屏机构场景、Agent 需求草案、场址闭环、场址控制、项目/WBS、合同授予，以及施工启动 → World 进度质量事实 → 人工里程碑验收；验收不会自动付款。项目 Agent 已把 completion 完整性恢复与治理字段纠正分开，各自有界且失败关闭。延期/缺陷/变更、工程发票/AP/CIP/付款、最终设施验收和 S5 全链仍未完成 |
