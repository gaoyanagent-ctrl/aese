...
F5B–F5C 已实现，F5D–F5E 保持未完成，不能把设计完成标记为运行完成。
...
baseline 1.2 提供可版本化 HCTM 模板和离线引用/期间连续性校验。F5D Business Partner/
产品组织扩展仍待实施。
...
| M9-FIN Manufacturing Finance Foundation | 在 M9 建立财务组织、账套、科目、期初资本会计和开业报表，并在 M10–M13 接通 AP/AR/资金/资产/成本/总账 | F5C Complete; F5D Active; M10–M13 Planned | M9 开业纵切、F5B 多组织/Data Set 与 F5C 账簿/科目/日历已交付；BP/产品组织扩展及 F15–F35 仍不得计入完成 |
