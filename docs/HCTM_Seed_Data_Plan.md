...
| 22 | `evt-20260720-0001` | `2026-07-20T11:00:00+08:00` | `o2d.shipment.dispatched` | `shipment` | `SHIP-202607-0002` | 第二批发货 3,000 件 |
...
LAS-WLD-02 停机 8 小时导致焊接产能短期下降，建议释放备选供应商 PO、启用加班，并采用 9,000 + 3,000 分批发运方案。
```
...
```text
通过启用备选供应商、加班和分批发运，最终交付风险从高降为可控。成本上升主要来自备选供应商采购、加严检验和加班；质量风险集中在备选供应商批次，需要质量隔离和放行决策支撑。
```
